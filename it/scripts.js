...
var deviceTypes = [
  {
    "name": "Computer fisso",
    "devices": [
      {"name": "Apple iMac 21,5 pollici", "production": 406.16, "usage": 151},
      {"name": "Apple iMac 27 pollici", "production": 589.98, "usage": 151},
      ...
      {"name": "Lenovo altro", "production": 420.32, "usage": 151},
      {"name": "HP Thin", "production": 111.13, "usage": 151},
      {"name": "HP Workstation", "production": 807.01, "usage": 151},
      {"name": "HP altro", "production": 484.74, "usage": 151},
      {"name": "Fujitsu Primergy", "production": 2536.74, "usage": 151},
      {"name": "Fujitsu altro", "production": 478.11, "usage": 151},
      {"name": "Dell", "production": 320.86, "usage": 151},
      {"name": "Computer fisso altro", "production": 294.93, "usage": 151}
    ]
  },
  {
    "name": "Laptop",
    "devices": [
      ...
      {"name": "Lenovo altro", "production": 264.28, "usage": 48},
      {"name": "Laptop altro", "production": 331.48, "usage": 48}
    ]
  },
  {
    "name": "Smartphone",
    "devices": [
      ...
      {"name": "Telefono altro < 128Go", "production": 44.07, "usage": 1.5},
      {"name": "Telefono altro > 128Go", "production": 58.33, "usage": 1.5}
    ]
  },
  {
    "name": "Tablet",
    "devices": [
      ...
      {"name": "Tablet altro", "production": 135.39, "usage": 5}
    ]
  },
  {
    "name": "Monitor",
    "devices": [
      ...
      {"name": "Monitor altro", "production": 348.6, "usage": 50}
    ]
  },
  {
    "name": "Stampante",
    "devices": [
      {"name": "Stampante grande formato", "production": 717.79, "usage": 71},
      {"name": "Stampante multifunzione da ufficio", "production": 234.4, "usage": 71}
    ]
  }
],
visioTools = [
...
$(document).ready(function () {
  ...
  function n(a, e) {
    a.append('<option value="placeholder">Scegliere...</option>');
    $.each(e, function (f, t) {
      var html = '';
  ...
  $(".add-device").on('click', function() {
    ...
    newDevice.find('.device-title').html('La mia apparecchiatura n°' + newDeviceID);
