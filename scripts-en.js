...
var deviceTypes = [
  {
    ...
    "devices": [
      {
        "name": "Apple iMac 21,5 inches",
        "production": 406.16,
        "usage": 151
      },
      {
        "name": "Apple iMac 27 inches",
        "production": 589.98,
        "usage": 151
      },
      {
  ...
  },
  {
    ...
    "devices": [
      {
        "name": "Large size printer",
        "production": 717.79,
        "usage": 71
      },
      {
        "name": "Office multifunction printers",
        "production": 234.4,
        "usage": 71
      }
    ]
...
$(document).ready(function () {
  var e = 0,
      ...
      currentEnergyMix;
  function n(a, e) {
    a.append('<option value="placeholder">Choose...</option>');
    $.each(e, function (f, t) {
      var html = '';
